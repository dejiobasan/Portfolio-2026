const FooterSection = () => {
  return (
    <section className="relative w-full flex flex-col items-center pt-20 lg:pt-32 bg-[#F9FAFB] overflow-hidden">
      <div className="w-[90%] lg:w-full flex flex-col items-center rounded-xl justify-center border-t-4 border-r-4 border-l-4 md:border-t-8 md:border-r-8 md:border-l-8 border-[#36363A] max-w-[1200px] h-[400px] md:h-[720px] mx-auto bg-white relative z-20 mb-[-200px] md:mb-[-360px] px-4 md:px-8">
        ...
        <p className="text-center text-base md:text-[20px] mt-2 md:mt-4 text-gray-700 max-w-[600px] md:max-w-none">
          I'm open to collaborating with startups, engineering teams, and{" "}
          <br className="hidden lg:block" />
          organizations to build impactful digital products.
        </p>
      </div>
      <div className="w-full pt-[260px] md:pt-[460px] pb-16 flex flex-col items-center z-10 relative bg-[#36363A] text-white">
